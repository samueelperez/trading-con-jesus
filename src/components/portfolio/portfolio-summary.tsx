                        ...
                        <td className="whitespace-nowrap px-3 py-4 text-sm">
                          {editingId === exchange.id ? (
                            <input
                              ...
                              className="w-28 rounded-md border-0 px-3 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-blue-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
                            />
                          ) : (
